...
from src.train.eval_callbacks import EvalCallBack
...
def train():
  ...
  model.fit(train_data, train_label, x_validate=test_data,
            y_validate=test_label, epochs=100, batch_size=256,
            callbacks=callbacks)
  return
